...
export const DIM = {
  ...
  // Restrained visual radius for the wound bass strings; kept thin enough that
  // the separate resonance overlay stays readable through its natural decay.
  bassStringRadius: 0.003,
